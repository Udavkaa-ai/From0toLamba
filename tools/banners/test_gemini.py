...
#   Free tier:  10 RPM, 500 RPD  (до привязки биллинга)
#   Tier 1:    150+ RPM          (биллинг привязан, pay-as-you-go)
# 10 RPM — безопасный предел для обоих тиров; 6 сек между запросами.
# Тест = 1 зонд + 3 баннера = 4 запроса → ~24 сек при 10 RPM.
DEFAULT_RPM = 10
