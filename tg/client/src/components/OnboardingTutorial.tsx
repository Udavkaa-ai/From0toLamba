...
const SLIDES: Slide[] = [
  ...
  },
  {
    ...
    body: 'Перед каждым делом — испытание на внимательность. Эталонная печать, а рядом 24 ячейки, где есть поддельные. Чем больше в деле лжи — тем больше подделок. Нашёл — получаешь очки чуйки. Пропустил — теряешь два.',
    accent: '👁 Чуйка: +1 за находку, −2 за пропуск, −1 за ложную тревогу',
  },
  {
    emoji: '👁',
    title: 'Чуйка — второй столп роста',
    body: 'Деньги без чуйки — тупик. Для повышения в чин нужна и казна, и острый глаз одновременно. Без нужного порога чуйки чин не растёт, даже если карман набит.',
    accent: 'Купец ≥ 20 · Мудрец ≥ 100 · Боярин ≥ 300 · Князь ≥ 500',
  },
  {
    emoji: '⚙️',
  ...
  {
    emoji: '❓',
    title: 'ЧАВО — твоя шпаргалка',
    body: 'Непонятно как выводить деньги, чем типы дел отличаются или что за «мафиозный выкуп»? Все ответы — в разделе ЧАВО. Заходи через ⚙️ Настройки → «ЧАВО».',
    accent: 'Там же: правила вывода по типам дел, личины хозяев, судьбы проектов',
  },
  {
    emoji: '📜',
