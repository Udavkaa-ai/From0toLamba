...
const SLIDES: Slide[] = [
  {
    ...
    body: 'Ты молодой купец в сказочной Руси. Стартуешь с пустыми карманами, а цель — взойти до Князя. Рубли вкладываешь в дела, что приносят хозяева, но многие из них обманщики — отличать правду от лжи научишься сам.',
  },
  {
    emoji: '✉️',
  ...
  },
  {
    emoji: '🎯',
    title: 'Пять судеб',
    body: 'Дело может сбежать с казной (самое подлое), тихо угаснуть, честно провалиться, выжить с прибылью или — единожды из десяти — взлететь до звезды. Разбор любого закрытого дела откроет его судьбу в «Летописи».',
    accent: '🦄 Поймай единорога — и обгонишь других купцов',
  },
  {
    emoji: '🏆',
    title: 'Чины и ярмарочный рейтинг',
    body: 'Скоморох → Купец → Мудрец → Боярин → Князь. Поднимаешься по чинам копя рубли и растя чуйку. В «Успехах» собирай подвиги — заодно откроешь справочник пород, личин и судеб.',
  },
]
