...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    items: [
      '📈 На графике дела появился поток вкладчиков — пунктирная синяя линия. Смотри на форму: у честного провала резкий взлёт и обвал, у жар-птицы — плато и затем взрывной рост',
      '🎭 Посул АРУ в карточке теперь привязан к реальной доходности: мошенники врут вверх, скромные основатели занижают. Высокий посул — не всегда признак скама',
      '⚔️ В «Купеческой грамоте» новые знаки: корона, меч, пламя. Похожие формы теперь заменяются на схожие (шестигранник ↔ восьмигранник), а разница в размере — всего 15%',
      '💰 Доходность всех дел повышена на 3 п.п. в день: честный провал 3–4%/день, выживший и тихий слив 4–7%, жар-птица 8–28%',
    ],
  },
  {
    version: '2.9.9',
