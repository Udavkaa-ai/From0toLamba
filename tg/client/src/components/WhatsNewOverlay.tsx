...
export const CHANGELOG: ChangelogEntry[] = [
  {
    version: '3.2.0',
    title: 'Ярмарка живёт — большое обновление',
    items: [
      '💬 Ярмарочная площадь — общий чат купцов. Нажми кнопку чата в правом углу, придумай торговое имя в настройках и болтай с другими. Ответы, удаление своих слов — всё есть. Матерщина выметается сама.',
      '🏪 Место под лишнее дело — заняты все пять? Можно открыть дополнительный торговый слот при вложении: 1 000 г или 10 ⭐. До пяти лишних дел сразу. После закрытия дела слот сгорает.',
      '👁 Беседа с дельцом — пока бесплатно. Задай хозяину до 10 вопросов перед вложением без Звёзд. Пользуйся, пока не кончился пробный период.',
      '📢 Награды за подписку на каналы — подпишись на официальный канал игры @vknyazi_izgryazi и на «Драгоценную печатку» @ssignet_ring, по +50 г за каждый. Забрать в разделе «Задания» на главной.',
    ],
  },
  {
    version: '2.9.10',
