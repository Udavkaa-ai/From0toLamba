...
export const MINIGAME_INFO: Record<string, MiniGameInfo> = {
  ...
  IVAN_DURAK: {
    ...
    hint: 'У Ивана и тебя одинаковые 7 карт. Иван открывает по одной — найди такую же в своей руке (она каждый ход тасуется). 15 секунд. 0 ошибок — совет чуйки; 1 — пройдёшь без подсказок; ≥2 — только за звёзды.',
    startBtn: 'Принять испытание →',
  },
}
