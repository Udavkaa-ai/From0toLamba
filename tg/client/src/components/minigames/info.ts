...
export const MINIGAME_INFO: Record<string, MiniGameInfo> = {
  ...
  KOSCHEI: {
    name: 'Память Кощея',
    hint: '12 карт лицом вниз. Открывай по две и собирай 6 пар: дуб, сундук, заяц, утка, яйцо, игла. 15 секунд на всё. 6 открытий — раскроется совет чуйки; 7 — пройдёшь без подсказок.',
    startBtn: 'Принять испытание →',
  },
  KOLOBOK: {
    name: 'Нора-нора-нора',
