...
export function HomePage() {
  ...
  // [4.4.2] Удалён 1с-тикер now=Date.now() — перерисовывал всю HomePage
  // каждую секунду, что вызывало мерцание framer-motion анимаций по всему
  // дереву. Использовался только в мёртвом коде NextDayFab/NextDayButton
