...
export const TYPE_LORE: Record<string, LoreEntry> = {
  ...
  HONEST_TRADE: {
    ...
    description: 'Самое понятное ремесло: купил подешевле, продал подороже, с прибыли платит вкладчикам. Без чудес — но без пирамид и котлов. Вывести гроши можно в любой день и без комиссии, только честные дела редко дают бешеный иксов — зато и сгорают реже.',
    hints: [
