 ...
 *  Бьёт каждый отдельный generateProject() в advance-day (1-3 в сутки), но
 *  generateProject ВНУТРИ проверяет что у игрока уже нет VIP в инбоксе —
 *  иначе на 10% шансе и 3 делах в день регулярно сыпало 2-3 одинаковых
 *  VIP-карточки за раз.
