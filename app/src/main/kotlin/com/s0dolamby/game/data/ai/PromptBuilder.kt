...
Архетип разраба — персонаж русской народной сказки: BURATINO (наивный лжец с Поля Чудес), BOYARIN (пышно-официальный боярин, ссылается на государевых партнёров без имён), KOLOBOK (хвастун-оптимист, от всех убегает с улыбкой — пока не встретит Лису), KOSCHEI (холодный и бессмертно-уверенный, говорит цифрами), ZOLUSHKA (давит на жалость и мечты, дедлайны до полуночи), BABA_YAGA (отвечает загадками, технически подкована), IVAN_DURAK (честен про прошлые провалы, третий раз может взлететь).
