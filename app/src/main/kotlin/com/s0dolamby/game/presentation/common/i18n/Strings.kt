...
object Strings {
    ...
    private val RU: Map<String, String> = mapOf(
        ...
        "zorkiy.stakes" to "Ставки: победа вернёт половину потерь. Собьёшься — дело замрёт на 2–3 дня без начислений. Совсем растеряешься — вывод запрут до закрытия дела!",
        ...
        "zorkiy.fail.title" to "Казна под замком",
        "zorkiy.fail.body" to "Полная неразбериха! Делец запер сундуки — вывод недоступен до самого закрытия дела.",
        ...
        "zorkiy.snack.lock" to "Вывод из дела заперт до закрытия",
    ...
    private val EN: Map<String, String> = mapOf(
        ...
        "zorkiy.stakes" to "Stakes: a win recovers half the losses. Slip up — the venture freezes for 2–3 days with no yield. Fall apart — withdrawals get locked until the venture closes!",
        ...
        "zorkiy.fail.title" to "Treasury under lock",
        "zorkiy.fail.body" to "Total mayhem! The dealer locked the chests — no withdrawals until the venture closes.",
        ...
        "zorkiy.snack.lock" to "Withdrawals locked until the venture closes",
