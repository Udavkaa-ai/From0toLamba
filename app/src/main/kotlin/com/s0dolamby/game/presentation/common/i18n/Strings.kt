...
object Strings {
    ...
    private val RU: Map<String, String> = mapOf(
        ...
        "sechenie.hint" to "Тапни по струне в нужном месте — попытка одна",
        ...
        "zorkiy.rules" to "В квадрате вразнобой спрятаны числа 1–10 и буквы-помехи. Тапай числа ПО ПОРЯДКУ. На всё про всё — 5 СЕКУНД. Жизнь жестока.",
    ...
    private val EN: Map<String, String> = mapOf(
        ...
        "sechenie.hint" to "Tap the string at the right spot — one attempt",
        ...
        "zorkiy.rules" to "Numbers 1–10 are hidden among letters, scattered at odd angles. Tap the numbers IN ORDER. You get 5 SECONDS total. Life is cruel.",
