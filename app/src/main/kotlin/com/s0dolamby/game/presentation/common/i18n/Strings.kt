...
object Strings {
    ...
    private val RU: Map<String, String> = mapOf(
        ...
        "zorkiy.stakes.mafia" to "Лихие люди зарятся на дело! Пройдёшь БЕЗ ЕДИНОЙ ошибки — прогонишь их, дело уцелеет. Ошибёшься или не успеешь — дело запрут и при закрытии вернут лишь половину.",
        "zorkiy.mafiaSafe.title" to "Отбились!",
        "zorkiy.mafiaSafe.body" to "Лихие люди ушли ни с чем — дело цело и работает дальше. Забрать всё нажитое сможешь как обычно.",
        "zorkiy.mafiaLocked.title" to "Дело под замком",
        "zorkiy.mafiaLocked.body" to "Отбиться не вышло — дело заперли. При закрытии вернут лишь половину нажитого.",
        ...
        "zorkiy.snack.mafiaSafe" to "Отбились! Лихие люди ушли — дело цело и работает дальше",
        "zorkiy.snack.mafiaLocked" to "Не отбились — дело под замком, при закрытии вернут лишь половину",
    ...
    private val EN: Map<String, String> = mapOf(
        ...
        "zorkiy.stakes.mafia" to "Rogues have their eyes on the venture! Finish with ZERO mistakes to drive them off and keep the deal. Slip up or run out of time — the deal gets locked and pays only half at closure.",
        "zorkiy.mafiaSafe.title" to "Fought them off!",
        "zorkiy.mafiaSafe.body" to "The rogues left empty-handed — the deal is safe and keeps running. You can cash out all your gains as usual.",
        "zorkiy.mafiaLocked.title" to "Deal locked",
        "zorkiy.mafiaLocked.body" to "Couldn't fend them off — the deal is locked. Only half your gains come back at closure.",
        ...
        "zorkiy.snack.mafiaSafe" to "Fought them off! The deal is safe and keeps running",
        "zorkiy.snack.mafiaLocked" to "Didn't fight them off — the deal is locked, only half back at closure",
