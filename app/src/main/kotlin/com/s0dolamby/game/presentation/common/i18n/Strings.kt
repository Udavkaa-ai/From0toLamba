...
object Strings {
    ...
    private val RU: Map<String, String> = mapOf(
        ...
        "zorkiy.rules" to "В квадрате вразнобой спрятаны числа 1–10 и буквы-помехи. Тапай числа ПО ПОРЯДКУ. На каждое следующее — 5 секунд.",
    ...
    private val EN: Map<String, String> = mapOf(
        ...
        "zorkiy.rules" to "Numbers 1–10 are hidden among letters, scattered at odd angles. Tap the numbers IN ORDER. 5 seconds per number.",
