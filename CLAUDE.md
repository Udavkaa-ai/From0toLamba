...
**Активная версия:** Telegram Mini App (`tg/`) — v1.5.16
...
- **Difficulty (сила мутации):**
  ...
  - `HARD` (SURVIVOR, UNICORN) — количество точек розетки (4↔8, через одну), малый сдвиг тона (±20°), зеркальное отражение эмблемы
